...
from train_cartpole_cleanrl_gae import ActorCriticNetwork


rom_time_check = True
env = gym.make("CartPole-v1", render_mode="human")
network = ActorCriticNetwork(env)
checkpoint = torch.load("rom_cleanrl_gae_cartpole.cleanrl_model", map_location="cpu")
