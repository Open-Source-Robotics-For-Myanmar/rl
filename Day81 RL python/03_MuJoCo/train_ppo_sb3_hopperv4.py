...
ENV_ID = "Hopper-v4"  # MuJoCo continuous-control env (observation & action နှစ်ခုစလုံး continuous)
...
VECNORMALIZE_PATH = Path("rom_sb3_ppo_hopperv4_vecnormalize.pkl")  # running obs/reward mean-std ကို ပြန်သုံးဖို့ သိမ်း
TENSORBOARD_LOG_DIR = Path("sb3_ppo_hopperv4_tensorboard")


def parse_args() -> argparse.Namespace:
	parser = argparse.ArgumentParser(description="Train SB3 PPO on Hopper-v4.")
...
def train(args: argparse.Namespace) -> None:
	...
	# Hopper-v4 လို continuous-control envs အတွက် running mean/std normalization က training stability ကို ကူညီတယ်
